...
<div style="background-color:rgba(0,128,128, 0.2); margin:50px; text-align:center;">
    <h1 style="display:block; text-align:center; padding:30px">INBOX</h1><br>
    <a href="{{route('sent.index')}}"><button style="font-size:14px;
        color:black;
        border-radius:8px;
        width:200px;
        padding: 5px 10px;
        ...
        text-align:center;
        margin:20px;
        background-color: aliceblue;" onMouseOver="this.style.color='blue'" onMouseOut="this.style.color='#000000'">SENT MESSAGES</button></a>
